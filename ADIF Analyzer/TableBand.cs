...
{
    public partial class TableBand : Form
    {
        ...
        /*-------------------------------------------------------------------------------
         * This table is being loaded.
         */
        private void TableBand_Load(object sender, EventArgs e)
        {
            Globals.RestoreFormPosition("Table Band", this, 211, 166);
         ...
         */
        private void TableBand_FormClosing(object sender, FormClosingEventArgs e)
        {
            Globals.SaveFormPosition("Table Band", this);
            Globals.objMain.TableBandClosed();
            return;
        }
        ...
        private void FillTable()
        {
            ...
            List<ConnectionCountItem> lstItems = Globals.objAdif.ConnectionsByBand();
            int intTotalCount = 0;
